...
\zihao{4}签字日期:\hspace{0.5em} #1 年#2月#3日
}
...
\ifboolexpr{bool{isHumanities}}{%
	...
	%4级标题
	%理工科类
	\newcommand{\smallTiltle}[1]{\par\zihao{4}\songti\hspace{1em} #1 \par}
...
%\usepackage{pdfpages} %直接插入pdf文件,单页也可以用includegraphics
