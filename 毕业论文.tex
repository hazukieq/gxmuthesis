...
\newenvironment{ol}{
	\begin{enumerate}[topsep=0pt,labelsep=.5em,leftmargin=3.5em,itemsep=0em,parsep=0em, partopsep=0pt,label=\arabic*.]		
}{\end{enumerate}}


\newenvironment{pol}[2]{
	\begin{enumerate}[topsep=0pt,labelsep=.5em,leftmargin=\the\dimexpr 0.5em+ #2\relax,itemsep=0em,parsep=0em, partopsep=0pt,label=#1]
		
}{\end{enumerate}}

\newenvironment{pul}[1]{
\begin{itemize}[topsep=0pt,labelsep=.5em,leftmargin=\the\dimexpr 0.5em+ #1\relax,itemsep=0em,parsep=0em, partopsep=0pt]
	
}{\end{itemize}}

\newenvironment{ul}{
	\begin{itemize}[topsep=0pt,labelsep=.5em,leftmargin=3em,itemsep=0em,parsep=0em, partopsep=0pt]		
}{\end{itemize}}
